...
import imageThree from '../../assets/img_four.png';

export default function ViewComponent4() {
    ...
    <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: '100px' }}>
      <Grid container spacing={2} maxWidth="lg">
        ...
        <Grid item xs={12} md={3} lg={4}>
          <Box>
            {['Android Mobile Development Application', 'IOS Mobile Development Application'].map((service, index) => (
              <Paper
                key={index}
                sx={{
